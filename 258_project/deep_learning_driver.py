...
class DeepLearningDriver(object):
    ...
    def __init__(self):
        ...
        logging.info('Creating a DeepLearningDriver...')
        ...
        self.video_orig = self.create_video_recorder('/home/pi/258_project/data/video.avi')
        self.video_lane = self.create_video_recorder('/home/pi/258_project/data/video.avi')
        self.video_objs = self.create_video_recorder('/home/pi/258_project/data/video.avi')

        logging.info('Created a DeepLearningDriver')
...
def main():
    with DeepLearningDriver() as car:
        car.drive(21)
